...
# Use static linking to avoid DLL dependencies
# Use -std=gnu17 to avoid C23 compatibility issues with old-style function declarations
# Add security flags: DYNAMICBASE for ASLR, NXCOMPAT for DEP
export CC="$HOST-gcc -static-libgcc -std=gnu17"
export CXX="$HOST-g++ -static-libgcc -static-libstdc++"
export AR=$HOST-ar
export RANLIB=$HOST-ranlib
export DLLTOOL=$HOST-dlltool
export WINDRES=$HOST-windres
export LDFLAGS="-static-libgcc -static-libstdc++ -Wl,--dynamicbase -Wl,--nxcompat -Wl,--tsaware"
